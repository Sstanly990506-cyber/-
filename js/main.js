...
import { renderCustomers, renderCustomerOptions, bindCustomerEvents } from './customers.js?v=20260714-completed-order-send-1';
import { renderOrders, renderOrderScreen, clearOrderForm, bindOrderEvents, openOrderForEdit } from './orders.js?v=20260714-completed-order-send-1';
...
import { renderTrips, bindTripEvents } from './trips.js?v=20260714-completed-order-send-1';
...
const APP_BUILD = '2026-07-14-completed-order-send-1';
