import { $, COMPANY_INFO, MODULE_DEFINITIONS, isModuleEnabledInSettings } from './shared.js?v=20260714-module-fix-1';
import { applyUiSettings, bindSettingsEvents, renderSettings } from './settings.js?v=20260714-module-fix-1';
import {
  state,
  configureStore,
  initializeStore,
...
import { renderCustomers, renderCustomerOptions, bindCustomerEvents } from './customers.js?v=20260714-module-fix-1';
import { renderOrders, renderOrderScreen, clearOrderForm, bindOrderEvents, openOrderForEdit } from './orders.js?v=20260714-module-fix-1';
import { renderFinance, bindFinanceEvents } from './finance.js?v=20260714-module-fix-1';
import { renderAudits, bindAuditEvents } from './audit.js?v=20260714-module-fix-1';
import { renderTrips, bindTripEvents } from './trips.js?v=20260714-module-fix-1';
import { renderOpsCenter, bindOpsCenterEvents } from './ops-center.js?v=20260714-module-fix-1';
import { renderInventory, bindInventoryEvents } from './inventory.js?v=20260714-module-fix-1';
import { renderNotifications, bindNotificationEvents } from './notifications.js?v=20260714-module-fix-1';

const APP_BUILD = '2026-07-14-module-fix-1';
