...
class StaticStructureTests(unittest.TestCase):
    ...
    def test_ai_order_recognition_fills_existing_form(self):
        ...
        self.assertNotIn("addEventListener('input', () => { syncBillingAndUpstream('billingCustomerInput')", orders)
        self.assertNotIn("addEventListener('input', () => { syncBillingAndUpstream('upstreamInput')", orders)
