...
class StaticStructureTests(unittest.TestCase):
    ...
    def test_line_customer_portal_has_admin_scope_controls_and_buttons(self):
        ...
        self.assertIn("state.userRole === 'admin'", notifications)
        self.assertNotIn("state.user?.role === 'admin'", notifications)
        self.assertLess(view.index('LINE 通知與回覆'), view.index('最新通知與系統事件'))
        self.assertIn("20260717-line-permissions-2", (ROOT / 'js' / 'view-loader.js').read_text(encoding='utf-8'))
        self.assertIn("notifications.js?v=20260717-line-permissions-2", (ROOT / 'js' / 'main.js').read_text(encoding='utf-8'))
        self.assertIn("view-loader.js?v=20260717-line-permissions-2", (ROOT / 'index.html').read_text(encoding='utf-8'))
