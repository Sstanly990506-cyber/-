...
class StaticStructureTests(unittest.TestCase):
    ...
    def test_customer_tax_id_is_present(self):
        ...
        self.assertNotIn("const upstream = $('upstreamOptions')", customers)
    ...
    def test_ai_order_recognition_fills_existing_form(self):
        ...
        self.assertNotIn('id="upstreamInput"', view)
        self.assertNotIn('id="upstreamOptions"', view)
        ...
        self.assertNotIn("$('upstreamInput')", orders)
